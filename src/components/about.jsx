...
import './about.css';
import dilpreet from "../media/dilpreet.jpg"
import lokesh from "../media/lokesh.jpg"
import gurjot from "../media/gurjotimage.jpg"
import hitesh from "../media/hitesh-image.jpg"
function About() {
  return (
    ...
    <div id="carouselExampleControls" className="conatiner-fluid carousel carousel-dark slide" data-bs-ride="carousel" data-bs-pause="hover">
      <div className="carousel-inner">
        ...
        <img className="kutta" src={lokesh} alt="dog-profile"/>
          <em>Lokesh Yadav</em>
          <h2>"I can finally shop with confidence, knowing that I'm getting the best deal possible."</h2>

        </div>
        <div className="carousel-item">
        <img className="kutta" src={dilpreet} alt="lady-profile"/>
  ...
  <div className=" team container py-5">
    ...
    <div className="row text-center">
      <div className="col-xl-6 col-sm-6 mb-5">
        <div className="bg-white rounded shadow-sm py-5 px-4"><img src={gurjot} alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
          <h5 className="mb-0">Gurjot Singh</h5><span className="small text-uppercase text-muted">Developer</span>
        </div>
      </div>

      <div className="col-xl-6 col-sm-6 mb-5">
        <div className="bg-white rounded shadow-sm py-5 px-4"><img src={hitesh} alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
